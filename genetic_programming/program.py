...
class _Program(object):
    ...
    Parameters:
        ...
        init_method (str) -- | grow | full | half and half |
        ...
        const_range (tuple of two floats) -- The range of constants to include in the formulas.
        ...
        parsimony_coefficient (float) -- large program에 penalty를 준다. Bloat 현상을 없앨 수 있고, 이를 통해 더 understandable한 result 얻을 수 있음, tuning이 많이 필요
            ...
            Bloat is when evolution is increasing the size of programs without a significant
            increase in fitness, which is costly for computation time and makes for
            a less understandable final result. 
    ...
    def build_program(self, random_state):
        ...
        Returns:
            program (list) -- The flattened tree representation of the program.
    ...
    def export_graphviz(self, fade_nodes=None):
        """
        Returns a string, Graphviz script for visualizing the program, 프로그램에 대한 graphiz를 보여줌
        
        Parameters:
            fade_nodes (list, optional) --     A list of node indices to fade out for showing which were removed during evolution.
       
        Returns:
            output (string) -- The Graphviz script to plot the tree representation of the program.
    ...
    def execute(self, X):
        ...
        Returns:
            y_hats (array-like, shape = [n_samples]) -- The result of executing the program on X.
    ...
    def get_all_indices(self, n_samples=None, max_samples=None,
        ...
        Parameters:
            ...
            max_samples (int) -- The maximum number of samples to use.
                
            random_state (RandomState instance) -- The random number generator.

        Returns:
            indices (array-like, shape = [n_samples]) -- The in-sample indices.
                
            not_indices (array-like, shape = [n_samples]) -- The out-of-sample indices.
    ...
    def raw_fitness(self, X, y, sample_weight):
        ...
        Parameters:
            ...
            sample_weight (array-like, shape = [n_samples]) -- Weights applied to individual samples.

        Returns:
            raw_fitness (float) -- The raw fitness of the program.
    ...
    def fitness(self, parsimony_coefficient=None):
        ...
        Parameters:
            parsimony_coefficient (float, optional) -- If automatic parsimony is being used, the computed value according to the population. Otherwise the initialized value is used.
                
        Returns:
            fitness (float) -- The penalized fitness of the program.
    ...
    def get_subtree(self, random_state, program=None):
        ...
        Parameters:
            ...
            program (list, optional) -- |default=None|, The flattened tree representation of the program. If None, the embedded tree in the object will be used.
                
        Returns:

            start, end (tuple of two ints) -- The indices of the start and end of the random subtree.
    ...
    def crossover(self, donor, random_state):
        ...
        Parameters:
            donor (list) -- The flattened tree representation of the donor program.
